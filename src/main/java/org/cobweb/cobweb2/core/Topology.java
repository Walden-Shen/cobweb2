...
public class Topology {
	...
	/**
	 * Get a valid random location which is generated by its specific random number generator.
	...
	/**
	 * Return the adjacent location given the current location
	 * @param location The given location, including its direction heading for
	 * @return the next location it will head for
	 */
